const contractAddress = "0x4a4131cCd627F1EC5145dC4786a4399ed859acef"; // Replace with your own contract address
const chain = 'goerli'; // goerli, polygon, or ethereum

const welcome_h1 = "Welcome to the CodeCats NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The CodeCats NFT Project is a decentralized, open-source project that aims to demonstrate how to develope and launch your own NFT Collection. Follow step by step on the <a href="https://youtube.com/sawgiedogs"  target="_blank" rel="noopener noreferrer">codeSTACKr</a> YouTube channel.';
